...
private:
  ...
  void InsertarHijoIzquierda(info_nodo * padre, info_nodo * hijo);
  void InsertarHijoIzquierda(info_nodo * padre, const T & et);
  void InsertarHijoDerecha(info_nodo * padre, info_nodo * hijo);
  void InsertarHijoDerecha(info_nodo * padre, const T & et);
